import {
    ...
    ACTION_CHANGE_SCAN_ORDER_PVZ_INPUT, ACTION_CHANGE_SET_PVZ_LIST, ACTION_CHANGE_ADDRESS_INPUT
...
export const actionChangeIsProgressIsExistsOrderNumber = (payload) => (
    {
        type: ACTION_CHANGE_IS_PROGRESS_IS_EXISTS_ORDER_NUMBER,
        payload
    }
)
...
export const actionChangeAddressInput = (payload) => (
    {
        type: ACTION_CHANGE_ADDRESS_INPUT,
        payload
    }
)
